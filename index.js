...
var jsCodeBlocks = document.getElementsByClassName('js;');
var htmlCodeBlocks = document.getElementsByClassName('xml;');
var cssCodeBlocks = document.getElementsByClassName('css;');

if(jsCodeBlocks.length>0){
    formatJSCode(jsCodeBlocks)
}
if(htmlCodeBlocks.length>0){
    formatHTMLCode(htmlCodeBlocks)
}
if(cssCodeBlocks.length>0){
    formatCSSCode(cssCodeBlocks)
}
